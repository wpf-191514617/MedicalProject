...
public class XRefreshViewHeader extends LinearLayout implements IHeaderCallBack {
    ...
    private void initView(Context context) {
        ...
        mProgressBar = (SimpleViewSwithcer) findViewById(R.id.xrefreshview_header_progressbar);
     ...
     * @param styleId
     */
    public void setProgressStyle(int styleId) {
        AVLoadingIndicatorView progressView = new AVLoadingIndicatorView(this.getContext());
        progressView.setIndicatorColor(0xffB5B5B5);
        progressView.setIndicatorId(styleId);
        mProgressBar.setView(progressView);
    }
