...
public class XRefreshView extends LinearLayout {
    ...
    private int refreshProgressStyle = ProgressStyle.BallSpinFadeLoader;
    /**
    ...
    private void addHeaderView() {
        ...
        mHeaderCallBack.setProgressStyle(this.refreshProgressStyle);
...
//                }
                ...
                if (onScroll != null) {
                    onScroll.onScrollTopOrButtomListener(mContentView.isTop(), mContentView.isBottom());
                }
     ...
     * 设置头部刷新样式
     */
    public void setRefreshProgressStyle(int styleId) {
        this.refreshProgressStyle = styleId;
    }
    ...
    private OnScrollTopOrButtomListener onScroll; //判断是否滑动到顶部了

    public void setOnScrollToTopLintener(OnScrollTopOrButtomListener listener) {
        onScroll = listener;
    }

    public interface OnScrollTopOrButtomListener {
        public void onScrollTopOrButtomListener(boolean isTop, boolean isButtom);
    }
