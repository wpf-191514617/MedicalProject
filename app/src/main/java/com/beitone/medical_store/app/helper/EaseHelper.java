...
import com.beitone.medical_store.app.EaseModel;
import com.beitone.medical_store.app.MainActivity;
import com.beitone.medical_store.app.R;
import com.beitone.medical_store.app.constant.EaseUIConstant;
import com.beitone.medical_store.app.db.DemoDBManager;
import com.beitone.medical_store.app.db.InviteMessgeDao;
import com.beitone.medical_store.app.db.UserDao;
import com.beitone.medical_store.app.domain.EmojiconExampleGroupData;
import com.beitone.medical_store.app.domain.InviteMessage;
import com.beitone.medical_store.app.domain.RobotUser;
import com.beitone.medical_store.app.parse.UserProfileManager;
import com.beitone.medical_store.app.receiver.CallReceiver;
import com.beitone.medical_store.app.receiver.HeadsetReceiver;
import com.beitone.medical_store.app.ui.interrogation.ChatActivity;
import com.beitone.medical_store.app.util.PreferenceManager;
import com.beitone.medical_store.app.domain.InviteMessage.InviteMessageStatus;
...
//        options.setImPort(6717);
    ...
    public void goConference(String confId, String password, String extension) {
        ...
        try {
            ...
            inviter = jsonObj.optString(EaseUIConstant.EXTRA_CONFERENCE_INVITER);
            groupId = jsonObj.optString(EaseUIConstant.EXTRA_CONFERENCE_GROUP_ID);
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    // 判断一下是否是会议邀请
                    String confId = message.getStringAttribute(EaseUIConstant.MSG_ATTR_CONF_ID, "");
                    if(!"".equals(confId)){
                        String password = message.getStringAttribute(EaseUIConstant.MSG_ATTR_CONF_PASS, "");
                        String extension = message.getStringAttribute(EaseUIConstant.MSG_ATTR_EXTENSION, "");
                        goConference(confId, password, extension);
                    }
