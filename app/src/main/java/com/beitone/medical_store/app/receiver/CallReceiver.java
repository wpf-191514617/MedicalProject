...
package com.beitone.medical_store.app.receiver;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(Build.VERSION.SDK_INT >= 29 && !EasyUtils.isAppRunningForeground(context)) {
            ...
            if("video".equals(type)) { //video call
                fullScreenIntent = new Intent();
               // fullScreenIntent.setClass(context, VideoCallActivity.class);
                content = context.getString(R.string.alert_request_video, from);
            }else {
                fullScreenIntent = new Intent();
               // fullScreenIntent.setClass(context, VoiceCallActivity.class);
            ...
            EaseHelper.getInstance().getNotifier().notify(fullScreenIntent, "Hyphenate", content);
		}else {
